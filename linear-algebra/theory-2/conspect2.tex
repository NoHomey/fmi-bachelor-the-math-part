...
\begin{document}
    ...
    Нека \(\n{f}\) - друг базис на \(\V\) \\\\
    Нека \(\m{g}\) - базис на \(\W\) \\\\
    Нека \(A = M_{e \to g}(\varphi)\) - матрицата на оператора \(\varphi\) спрямо базисите \(e, \; g\) \\\\
    и нека \(B = T_{e \to f}\) - матрицата на прехода между базисите \(e\) и \(f\). \\\\
    Тогава \(C = AB\) е матрицата на оператора \(\varphi\) спрямо базисите \(f, \; g\). \\\\
    Тоест \(C = M_{e \to g}(\varphi)T_{e \to f}\)
    ...
    Нека \(\n{e}\) - един базис на \(\V\) \\\\
    Нека \(\n{f}\) - друг базис на \(\V\) \\\\
    Нека \(A = M_e(\varphi)\) - матрицата на оператора \(\varphi\) в базиса \(e\) \\\\
    и нека \(B = T_{e \to f}\) - матрицата на прехода между базисите \(e\) и \(f\). \\\\
    Тогава \(C = B^{-1}AB\) е матрицата на оператора \(\varphi\) в базиса \(f\). \\\\
    Тоест \(C = T_{f \to e}M_e(\varphi)T_{e \to f}\)
