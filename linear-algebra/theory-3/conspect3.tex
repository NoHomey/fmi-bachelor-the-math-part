...
\begin{document}
    ...
    \inv \text{ - брой инверсии} \implies 1 \leq \inv \leq \frac{n(n - 1)}{2}\)
    ...
    \leta \\\\
    \acols \(A = (a_1 \; \dots \; a_n) \quad i \in \{1, \; \dots, \; n\}, \; \lambda \in \F \\\\
    ...
    \subsection{Промяна на детерминантата на една матрица, ако към един нейн ред прибавим умножен с число друг, различен от него, ред}
    \leta \\\\
    \arows \(A = \begin{pmatrix} a_1\\ \vdots\\ a_n \end{pmatrix} \; \text{ и нека } \iandj, \; \lambda \in \F \\\\
    ...
    \subsection{Промяна на детерминантата на една матрица, ако един нейн стълб прибавим умножен с число друг, различен от него, стълб}
    \leta \\\\
    \acols \(A = (a_1 \; \dots \; a_n) \; \text{ и нека } \iandj, \; \lambda \in \F \\\\
    ...
    Защото: \\\\
    \(\det(A + B) = \det\left(\begin{pmatrix}
    c_{11} & c_{12} & \cdots & c_{1n} \\
    c_{21} & c_{22} & \cdots & c_{2n} \\
    \vdots & \vdots & \ddots & \vdots \\
    a_{81} & a_{82} & \cdots & a_{8n} \\
    \vdots & \vdots & \ddots & \vdots \\
    ...
    c_{21} & c_{22} & \cdots & c_{2n} \\
    \vdots & \vdots & \ddots & \vdots \\
    b_{81} & b_{82} & \cdots & b_{8n} \\
    \vdots & \vdots & \ddots & \vdots \\
    c_{n1} & c_{n2} & \cdots & c_{nn} \\
    \end{pmatrix}\right) = \\\\
    \begin{vmatrix}
    2c_{11} & 2c_{12} & \cdots & 2c_{1n} \\
    2c_{21} & 2c_{22} & \cdots & 2c_{2n} \\
    \vdots & \vdots & \ddots & \vdots \\
    a_{81} + b_{81} & a_{82} + b_{82} & \cdots & a_{8n} + b_{8n} \\
    \vdots & \vdots & \ddots & \vdots \\
    2c_{n1} & 2c_{n2} & \cdots & 2c_{nn} \\
    \end{vmatrix} = 2^{n - 1}\begin{vmatrix}
    c_{11} & c_{12} & \cdots & c_{1n} \\
    c_{21} & c_{22} & \cdots & c_{2n} \\
    \vdots & \vdots & \ddots & \vdots \\
    a_{81} + b_{81} & a_{82} + b_{82} & \cdots & a_{8n} + b_{8n} \\
    ...
    \end{vmatrix} \neq 0 \\\\
    \forall \; k \in \N \; : \; r < k \leq n \\\\
    \forall \; 1 \leq l_1 < t_2 < \dots < l_k \leq n \\\\
    \forall \; 1 \leq t_1 < t_2 < \dots < t_k \leq n \; : \\\\
    \begin{vmatrix}
        a_{l_1t_1} & \cdots & a_{l_1t_r}\\
        \vdots & \ddots & \vdots\\
        a_{i_rt_1} & \cdots & a_{i_rt_r}
    \end{vmatrix} = 0\)
    \section{}
